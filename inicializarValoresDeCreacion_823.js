(function () {
    ...
    function imprimir() {
        ...
        asignadoa = acciones.recoverValor['oculto']($('#editar_e_nombre'))[0] + ' ' + acciones.recoverValor['oculto']($('#editar_e_apellido'))[0];
        ...
        tabla =  [  '<tr><td>Nro Orden </td><td>Nro Cotizacion</td><td>Fecha Creacion</td><td>Asignada al empleado</td></tr>',
